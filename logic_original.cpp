...
{	
	...
	cout << "Zeige Name: " << c->firstname << endl;
	//Navigation durch Liste mit l.getNext bzw l.getPrev
	c = l.getNext(c);
	cout << "Zeige Name: " << c->firstname << endl;

	//Suche auf Feld über funktion findContact
	//0 surname
	//1 firstname 
	//2 phone
	//3 street
	...
	//6 house number
	//7 Zip Code
	// wenn nichts gefunden wird, wird der ursprüngliche Kontakt zurückgegeben, deshalb muss c übergeben werden

	// erstes Argument kann entweder String oder int übergeben werden, wichtig ist das letzte argument Abhängig vom Feld
	c = l.findContact(999, c, 6);
	cout << "Rückgabe Suche  "<<  c->firstname << endl;

	c = l.getNext(c);
	cout << "Zeige Name: " << c->firstname << endl;

	c = l.findContact("xyz", c, 5);
	cout << "Rückgabe Suche  "<<  c->firstname << endl;
	...
	//Aufruf sort mit integer 1 oder 0; der Integer Wert bestimmt die Sortierungsrichtung/ aufstegend bzw absteigend
	//Sort 0, decrease 1 increase
	l.sortByPhone(1);
	l.output();
	//Suche auf int
	//0 house number
	//1 zip code
	//beim Suchen wird der gespeicherte Kontakt noch nicht korrekt zurückgegeben 
	
	//cout << "Gefunden wurde Nachname: " << c->surname << endl;
